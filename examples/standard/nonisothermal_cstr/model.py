"""
Non-isothermal CSTR model — exothermic reaction A+B → C.

States: Ca, Cb, Cc, Cm (mol/L), T (K)
MVs:    Fa0 — feed rate of A (mol/min), bounds [10, 100]
        mc  — coolant flow rate (mol/min), bounds [250, 1000]
DVs:    Fb0 — feed rate of B (fixed parameter)
        UA  — heat transfer coefficient*area (fixed parameter)
...
def variables_initialize(m):
    """
    Declare all Pyomo variables, sets, and parameters for the non-isothermal CSTR.
